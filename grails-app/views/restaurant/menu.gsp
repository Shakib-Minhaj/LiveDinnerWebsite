    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <asset:image src="images/logo.png" alt="" />
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbars-rs-food">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><g:link class="nav-link" controller="restaurant" action="menu">Menu</g:link></li>
                    <li class="nav-item"><g:link class="nav-link" controller="restaurant" action="about">About</g:link></li>
